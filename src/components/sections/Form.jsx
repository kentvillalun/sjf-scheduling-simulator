        ...
        {step === 2 && (
          <div className="mx-auto px-6 max-w-3xl md:max-w-5xl flex flex-col items-center justify-center gap-7">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="grid grid-cols-3 text-center gap-6 items-center justify-center font-medium md:gap-40 ">
              ...
              <div className="grid grid-cols-3 text-center gap-6 items-center justify-center font-medium md:gap-40">
                <input type="text" className="focus:outline-none px-4 py-2 bg-white/8 rounded-lg border-white/5 border focus:border-white/20 transition-all duration-200 text-center" />
                <input type="text" className="focus:outline-none px-4 py-2 bg-white/8 rounded-lg border-white/5 border focus:border-white/20 transition-all duration-200 text-center" />
                <input type="text" className="focus:outline-none px-4 py-2 bg-white/8 rounded-lg border-white/5 border focus:border-white/20 transition-all duration-200 text-center" />
